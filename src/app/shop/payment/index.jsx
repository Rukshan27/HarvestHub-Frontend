...
const PaymentShop = () => {
  const { getTotalCartAmount, cartItems, setCartEmpty } =
  ...
  const handleSavePayment = async () => {
    try {
      ...
      await http.post("bill/create", paymentOb);
    ...
    <ShopLayout
      body={
        <div className="w-full h-full flex justify-center items-center my-6">
          <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0 w-96">
              ...
              <div className="mt-6 border-t border-b py-2">
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-semibold text-gray-900">
                    Rs {floatToStringFormatter(getTotalCartAmount())}
                  </p>
                </div>
                <div className="flex items-center justify-between">
